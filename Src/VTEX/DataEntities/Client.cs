...
// ***********************************************************************
// <copyright file="Client.cs" company="Guilherme Branco Stracini">
...
namespace VTEX.DataEntities
{
    ...
    public class Client : IDataEntity
    {
        ...
        /// </summary>
        /// <value><c>true</c> if this instance is newsletter opt in; otherwise, <c>false</c>.</value>
